...
- pandas
## How to run:
Models generated by the Integrated Genome Modeling Platform (IGM) (https://github.com/alberlab/igm) (saved as for example "H1_igm-model.hss") should be placed under directory Model/ for further usage. The precalculated compartment file (saved as for example "H1_compartments.npy" for H1-hESC) and speckle distance file (saved as for example "H1_speckle_distance.npy" for H1-hESC) should be saved under directory Model/.
